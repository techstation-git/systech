frappe.query_reports["Supplier General Report"] = {
    "filters": [
        {
            "fieldname": "from_date",
            "label": __("From Date"),
        ...
        },
        {
            ...
            "on_change": function () {
                ...
                if (supplier) {
                    // Filter brands (Item Groups) based on supplier's items in Purchase Invoices
        ...
        },
        {
            ...
            "on_change": function () {
                ...
                if (brand) {
                    // Filter suppliers based on brand
        ...
        report.page.add_inner_button(__('Send to Email'), function () {
            let d = new frappe.ui.Dialog({
                ...
                fields: [
                    ...
                    { fieldtype: 'Data', fieldname: 'subject', label: __('Subject'), default: 'Supplier General Report' },
                ...
                primary_action: function (values) {
                    frappe.call({
                        ...
                        args: {
                            report_name: 'Supplier General Report',
                            filters: report.get_values(),
                            recipients: values.email,
                            subject: values.subject,
                            message: 'Please find attached the Supplier General Report.',
