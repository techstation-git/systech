frappe.query_reports["General Report {Project and Customer}"] = {
    "filters": [
        {
            "fieldname": "timespan",
            "label": __("Range"),
    ...
    "after_datatable_render": function (datatable) {
        $(".report-summary-item").css({
            ...
            frappe.set_route("query-report", "Detailed Report {Project and Customer}", {
        ...
        report.page.add_inner_button(__('Send to Email'), function () {
            let d = new frappe.ui.Dialog({
                ...
                fields: [
                    ...
                    { fieldtype: 'Data', fieldname: 'subject', label: __('Subject'), default: 'General Report {Project and Customer}' },
                ...
                primary_action: function (values) {
                    frappe.call({
                        ...
                        args: {
                            report_name: 'General Report {Project and Customer}',
